...
describe('RestaurantService', () => {
  ...
  describe('Computed Signals', () => {
    ...
    it('should return EUR currency when restaurant is not loaded', () => {
      expect(service.currency()).toBe('EUR');
    });

    it('should compute currency from the loaded restaurant', async () => {
      const mockRestaurant = createMockRestaurant({ currency: 'USD' });
