...
process.env.PIN_LOOKUP_PEPPER = 'test_pin_lookup_pepper_at_least_32_characters_long';
...
// Note: pin-security.service is no longer mocked by default so the
// pin-security unit tests exercise the real Redis-backed implementation.
// Other tests that relied on the old in-memory mock should import helpers
// from pin-security.service directly.
