...
// Localized field: array of { lang, value } where lang is an app language
// code ('es' | 'en' | 'fr') aligned with the restaurant's enabled_languages.
...
const CategorySchema = new Schema<ICategory>(
  {
    ...
    category_image_url: String,
    unlimited_orders: { type: Boolean, default: false },
  },
  { timestamps: true }
);
