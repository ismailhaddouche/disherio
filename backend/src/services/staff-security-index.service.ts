...
/**
 * Upgrades the former non-unique PIN lookup index before traffic is accepted.
 * Historical duplicate lookup keys require operator reconciliation because
 * choosing an account automatically would preserve the authentication flaw.
 */
export async function ensureUniqueStaffPinIndex(): Promise<void> {
