...
export class DishRepository extends BaseRepository<IDish> {
  ...
  async findByIdAndRestaurant(id: string, restaurantId: string): Promise<IDish | null> {
    validateObjectId(id, 'dish_id');
    validateObjectId(restaurantId, 'restaurant_id');
  ...
  async findByCategoryId(categoryId: string, restaurantId: string): Promise<IDish[]> {
  ...
  async updateDish(id: string, restaurantId: string, data: UpdateDishData): Promise<IDish | null> {
    validateObjectId(id, 'dish_id');
    validateObjectId(restaurantId, 'restaurant_id');
    const { restaurant_id: _restaurantId, category_id, disher_alergens, ...rest } = data;
    if (category_id !== undefined) validateObjectId(category_id, 'category_id');
  ...
  async countByCategory(categoryId: string, restaurantId: string): Promise<number> {
    validateObjectId(categoryId, 'category_id');
    validateObjectId(restaurantId, 'restaurant_id');
    return this.model
      .countDocuments({
...
export class CategoryRepository extends BaseRepository<ICategory> {
  ...
  async findByIdAndRestaurant(id: string, restaurantId: string): Promise<ICategory | null> {
